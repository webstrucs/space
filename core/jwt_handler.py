# Conteúdo para: py_core/src/security/jwt_handler.py
...
JWT_SECRET = "sua-chave-super-secreta-e-longa"
...
def create_token(payload: Dict[str, Any], lifetime_seconds: int = 3600) -> str:
    ...
    # Adiciona claims padrão (Issued At, Expiration Time)
...
def verify_and_decode_token(token: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        # Recria a assinatura a partir do header e payload
